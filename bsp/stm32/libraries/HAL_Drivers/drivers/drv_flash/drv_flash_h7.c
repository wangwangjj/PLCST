...
const struct fal_flash_dev stm32_onchip_flash_128k = { "onchip_flash_2048k", STM32_FLASH_START_ADRESS, 2048*1024, (2048 * 1024), {NULL, fal_flash_read_128k, fal_flash_write_128k, fal_flash_erase_128k} };
